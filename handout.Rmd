...
1. Insert a table into your sample RMarkdown document. 
2. Insert a graph of your choice, made using the `mtcars` dataset. 
...
We're going to use the `papaja` package. To install this, we'll need the `devtools` package (required above). Then run `devtools::install_github("crsh/papaja")`. Once you've got this working
